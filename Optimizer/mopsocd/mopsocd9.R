...
mopsocd9 <- function(fn,gn,varcnt,fncnt,lowerbound,upperbound,opt,popsize,maxgen,archivesize,verbosity,pMut,w1,w2,c1,c2,vclamp) UseMethod("mopsocd9")
mopsocd9 <- function(fn,gn=NULL,varcnt,fncnt,lowerbound,upperbound,opt,popsize=54,maxgen=9,archivesize=200,verbosity=0,pMut=0.5,w1=0.9,w2=0.4,c1=1.494,c2=1.494,vclamp=0.5)
{
