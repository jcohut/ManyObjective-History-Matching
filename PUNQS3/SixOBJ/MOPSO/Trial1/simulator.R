...
source('E:/GoForIT2/Optimizer/mopsocd/mopsocd6.R')
...
# p1 <- 2 # RVEA
# p2 <- 0 # RVEA
algorithm <- mopsocd6 # mopsocd # mopsopsa
...
# For NSGAII
    ...
    write.table(stored_misfits, file=paste(output_dir,"stored_misfits_mopso.csv",sep=""), col.names=TRUE, row.names=FALSE, sep=',')
    write.table(stored_param, file=paste(output_dir,"stored_param_mopso.csv",sep=""), col.names=TRUE, row.names=FALSE, sep=',')
